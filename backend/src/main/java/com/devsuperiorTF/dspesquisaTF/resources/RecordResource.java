...
import com.devsuperiorTF.dspesquisaTF.services.RecordService;
...
public class RecordResource {
	...
	public ResponseEntity<Page<RecordDTO>> findAll(
		...
		Instant maxnDate = ("".equals(max)) ? null : Instant.parse(max);
		...
		Page<RecordDTO> list = service.findByMoments(minDate, maxnDate, pageRequest);
